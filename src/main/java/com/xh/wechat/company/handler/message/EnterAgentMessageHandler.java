 ...
 *
 * @author: XieHua
 * @date: 2021-12-07 12:51
 */
public class EnterAgentMessageHandler extends AbstractMessageHandler {
    public EnterAgentMessageHandler(String corpId, Integer agentId) {
        this.corpId = corpId;
